...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LibrarySystemConnectionString2 %>" SelectCommand="SELECT * FROM [BranchMst]"></asp:SqlDataSource>
    <table class="tbl">
    <tr>
        <td class="tblhead">
            ADD NEW BRANCH</td>
        ...
        <td>
            <table align="center" class="style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtaddbranch" runat="server" CssClass="txt" OnTextChanged="txtaddbranch_TextChanged"></asp:TextBox>
